...
public class TestES {
    ...
    //如果要操作Redis，需要获取一个RedisTemplate
    //如果要操作ES，需要获取一个ElasticsearchTemplate
    @Resource
    ...
    /**
     * 02-创建一个索引库：Goods索引库，搜索的是实际项目中的数据！
     */
    @Test
    public void testCreateIndex(){
        ...
        elasticsearchTemplate.putMapping(Goods.class); //因为类上有注解
    ...
    public void getDocumentById(){
        Goods goods = goodsService.getDocumentById(149187842867916L);
        System.out.println("查询出的对象是："+goods);
    }
    ...
    public void testUpdateById(){
        ...
        goods.setCaption("阿玛尼装逼神器，泡妞必备，值得拥有");
    ...
    public void testDeleteById(){
        goodsService.deleteDocumentById(149187842867916L);
    ...
    public void testQuery1(){
        ...
        System.out.println("每页的数据是：");
        List<Goods> pageList = page.getContent();
    ...
    public void testQuery2(){
        ...
        NativeSearchQuery query = builder.withPageable(PageRequest.of(pageIndex - 1, pageSize)).build();
